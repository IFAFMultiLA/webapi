    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.JSONField(
                blank=True, default=api.models.application_config_default_json_instance, verbose_name="Configuration"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tracking_session",
                    models.ForeignKey(
                        default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to="api.trackingsession"
                    ),
                ),
            ],
        ),
