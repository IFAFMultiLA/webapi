...
ALLOWED_HOSTS = []
CORS_ALLOWED_ORIGINS = ['http://localhost:8001', 'http://localhost:8002', 'http://localhost:8003']
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1:8001', 'http://127.0.0.1:8002', 'http://127.0.0.1:8003']
